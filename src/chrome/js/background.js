...
var Background = (() => {
  ...
  const STORAGE_DEFAULT_VALUES = {
    ...
    "nextKeywords": ["pnnext","nextpage","next-page","next_page","next>","next»","next→","next","moreresults","olderposts","olderpost","arrow-right","angle-right","chevron-right","caret-right","circle-right","square-right","下一页","次のページ","次","&gt;",">","›","→","»","-right","_right","older","forward"],
    "prevKeywords": ["pnprev","previouspage","prevpage","prev-page","prev_page","<prev","«prev","←prev","prev","previous","newerposts","newerpost","arrow-left","angle-left","chevron-left","caret-left","circle-left","square-left","上一页","前のページ","前","&lt;","<","‹","←","«","-left","_left","newer"],
